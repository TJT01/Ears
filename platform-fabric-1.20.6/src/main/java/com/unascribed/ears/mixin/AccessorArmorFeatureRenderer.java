...
public interface AccessorArmorFeatureRenderer<T extends LivingEntity, A extends BipedEntityModel<T>> {
	...
	void ears$renderArmorParts(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, A model, float red, float green, float blue, Identifier overlay);
