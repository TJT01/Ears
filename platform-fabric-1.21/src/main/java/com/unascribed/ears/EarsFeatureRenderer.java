...
public class EarsFeatureRenderer extends FeatureRenderer<AbstractClientPlayerEntity, PlayerEntityModel<AbstractClientPlayerEntity>> {
	...
	private final IndirectEarsRenderDelegate<MatrixStack, VertexConsumerProvider, VertexConsumer, AbstractClientPlayerEntity, ModelPart> delegate = new IndirectEarsRenderDelegate<>() {
		...
		protected void doBindBuiltin(TexSource src) {
			...
			if (src.isGlint()) {
				...
				try {
					...
					aafr.ears$renderArmorParts(matrices, vcp, 0, dummyModel, 0xFFFFFF, l.getTexture(aafr.ears$usesSecondLayer(slot)));
		...
		public float getTime() {
			...
			return peer.age+minecraft.getRenderTickCounter().getTickDelta(minecraft.isPaused());
		}
		...
		public float getHorizontalSpeed() {
			MinecraftClient minecraft = MinecraftClient.getInstance();
			return EarsCommon.lerpDelta(peer.prevHorizontalSpeed, peer.horizontalSpeed, minecraft.getRenderTickCounter().getTickDelta(minecraft.isPaused()));
		}

		@Override
		public float getLimbSwing() {
			MinecraftClient minecraft = MinecraftClient.getInstance();
			return peer.limbAnimator.getSpeed(minecraft.getRenderTickCounter().getTickDelta(minecraft.isPaused()));
		}

		@Override
		public float getStride() {
			MinecraftClient minecraft = MinecraftClient.getInstance();
			return EarsCommon.lerpDelta(peer.prevStrideDistance, peer.strideDistance, minecraft.getRenderTickCounter().getTickDelta(minecraft.isPaused()));
		}

		@Override
		public float getBodyYaw() {
			MinecraftClient minecraft = MinecraftClient.getInstance();
			return EarsCommon.lerpDelta(peer.prevBodyYaw, peer.bodyYaw, minecraft.getRenderTickCounter().getTickDelta(minecraft.isPaused()));
		}

		@Override
		public double getCapeX() {
			MinecraftClient minecraft = MinecraftClient.getInstance();
			return EarsCommon.lerpDelta(peer.prevCapeX, peer.capeX, minecraft.getRenderTickCounter().getTickDelta(minecraft.isPaused()));
		}

		@Override
		public double getCapeY() {
			MinecraftClient minecraft = MinecraftClient.getInstance();
			return EarsCommon.lerpDelta(peer.prevCapeY, peer.capeY, minecraft.getRenderTickCounter().getTickDelta(minecraft.isPaused()));
		}

		@Override
		public double getCapeZ() {
			MinecraftClient minecraft = MinecraftClient.getInstance();
			return EarsCommon.lerpDelta(peer.prevCapeZ, peer.capeZ, minecraft.getRenderTickCounter().getTickDelta(minecraft.isPaused()));
		}

		@Override
		public double getX() {
			MinecraftClient minecraft = MinecraftClient.getInstance();
			return EarsCommon.lerpDelta(peer.prevX, peer.getPos().x, minecraft.getRenderTickCounter().getTickDelta(minecraft.isPaused()));
		}

		@Override
		public double getY() {
			MinecraftClient minecraft = MinecraftClient.getInstance();
			return EarsCommon.lerpDelta(peer.prevY, peer.getPos().y, minecraft.getRenderTickCounter().getTickDelta(minecraft.isPaused()));
		}

		@Override
		public double getZ() {
			MinecraftClient minecraft = MinecraftClient.getInstance();
			return EarsCommon.lerpDelta(peer.prevZ, peer.getPos().z, minecraft.getRenderTickCounter().getTickDelta(minecraft.isPaused()));
		}
	};
}
